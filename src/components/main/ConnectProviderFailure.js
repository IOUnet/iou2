...
export default function ConnectProviderFailure({ type = 'error' }) {
  ...
  return (isRequest
    ...
    : (<NotificationContainer type={type}>
        ...
        <Body>
          <h1> Welcome to Talimtoken IOUVerse!</h1> <p>
          Unfortunately, Talimtoken dApp failed to connect to blockchain provider  in your browser<br/>
          ...
          <p>
            Also, you can read in Google Docs how to configure your wallet manually <br/>
            <Anchor target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/e/2PACX-1vQcv_ZTJD6-54AMjLLCXQv1LtMSOtLdBzhGXo0aAIDkGljgivZABIMQbJyIOF0c6r1W9w8cNY4ATUoE/pub#h.657r6xhsbgq"> HOWTO issue  IOU Talimtoken </Anchor>
          </p>
        </Body>
