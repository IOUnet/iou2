...
interface  iStoreIOUs {
    ...
    function addAdminIOU (address _admin) external;
    function delAdminIOU (address _admin) external;
    function getOwnerIOU (address _admin) external view returns (address);
